...
#### Solución
```
┌──(kali㉿kali)-[~/picoctf/reversing/training]
...
Enter vault password: w4rm1ng_Up_w1tH_jAv4_000wYdiGTvt
Access denied!
                                                                                            
┌──(kali㉿kali)-[~/picoctf/reversing/training]
└─$ java VaultDoorTraining.java
Enter vault password: picoCTF{w4rm1ng_Up_w1tH_jAv4_000wYdiGTvt}
Access granted.
