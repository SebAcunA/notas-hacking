...
#### Solución
```
┌──(kali㉿kali)-[~/picoctf/reversing/VaultDoor5]
└─$ cat VaultDoor5.java
...
```
Extraer la cadena encriptada y concatenarla e ir a cyberchef
```
...
#### Referencias
https://gchq.github.io/CyberChef/#recipe=From_Base64('A-Za-z0-9%2B/%3D',true,false)URL_Decode(true)&input=SlRZekpUTXdKVFpsSlRjMkpUTXpKVGN5SlRjMEpUTXhKVFpsSlRZM0pUVm1KVFkySlRjeUpUTXdKVFprSlRWbUpUWXlKVFl4SlRNMUpUWTFKVFZtSlRNMkpUTTBKVFZtSlRZeUpUWTFKVE01SlRZMkpUTXhKVE13SlRZeEpUTTA&ieol=CRLF&oeol=CRLF